    ...
    <div className="flex justify-center">
      ...
      <div className="text-center w-8/12">
        ...
        <p className="leading-8">
          ...
          professional knowledge and numerous certification is business
          Development, investment , Forex Trading , Construction and Business
          Management and many more . His goal and slogan has always been to live
